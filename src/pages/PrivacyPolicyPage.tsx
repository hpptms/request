        ...
        <Stack spacing={3}>
          ...
          <Box>
            ...
            <Typography variant="body1">
              本サービスの利用にあたり、氏名やメールアドレス等の登録は必要ありません。一方で、不正利用・荒らし行為を防止する目的で、リクエストや投票の際のIPアドレスを取得し、レート制限や自動BAN等の判定に利用しています。また、時間帯別のいいね数ランキング(上位5位の方への通知表示)のため、リクエスト元のIPアドレスを時間帯ごとに集計して保存しています。
            </Typography>
          </Box>
