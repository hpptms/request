      ...
      <Container maxWidth="sm" sx={{ py: { xs: 2, sm: 4 }, px: { xs: 1.5, sm: 3 } }}>
        <Stack spacing={3}>
          ...
          <Box>
            ...
            <Typography variant="body1">
              当サイトは、Amazonアソシエイト・プログラムおよび楽天アフィリエイトの参加者です。再生中の曲の横や集計ページに表示する「Amazon」「楽天」のリンクは広告(アフィリエイトリンク)で、リンク先で商品を購入すると、当サイトが紹介料を受け取ることがあります。Amazonアソシエイトとして、適格販売により収入を得ています。これらのリンクをクリックすると、各社のサイトでCookie等が利用されることがあります。
            </Typography>
          </Box>
