...
// UTC keeps the calendar math independent of whatever timezone the viewer's
...
// Shared body for the stats screen: backend/internal/analytics に蓄積された
// 「動画/チャンネルごとの日別リクエスト数・いいね数・bad(キャンセル投票)数」
